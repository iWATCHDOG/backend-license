...
public class RateLimiter {
	private static final long MAX_REQUESTS_PER_PERIOD = 20; // 设置最大请求次数
	...
	public boolean isOverLimit(String ipAddress) {
		return requestCounts.compute(ipAddress, (ip, counter) -> {
			// 如果counter为null或者当前时间与counter的时间戳之差大于15秒，则重置counter
			...
			// 如果当前时间与counter的时间戳之差小于15秒，则判断当前请求次数是否大于15次
